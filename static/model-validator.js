// TFLite Model Validation Utility - Browser Compatible Version
class ModelValidator {
  ...
  async testModelInference(model) {
    ...
    const dummyTensor = window.tf.tensor4d(dummyData, [1, 4, 21, 3])
  ...
  async checkModelFile() {
    try {
      const response = await fetch("/static/tfjs_model/model.json")
